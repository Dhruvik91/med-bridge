            ...
            },
            {
                ...
                cell: ({ row }) => {
                    ...
                    const roleColors = {
                        ...
                        employer: 'bg-secondary text-secondary-foreground',
                        candidate: 'bg-primary/10 text-foreground',
                    };
                    return (
                ...
                <CardContent>
                    <div className="flex gap-4">
                        ...
                        <select
                            ...
                            className="h-10 px-4 py-2 border border-input bg-background text-foreground rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background text-sm"
                        >
