...
import { Stethoscope, Briefcase, Mail, Lock, User, AlertCircle } from 'lucide-react'
...
export default function SignUpPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    confirmPassword: '',
    name: '',
    role: (searchParams.get('role') as 'doctor' | 'hospital') || 'doctor'
  })
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <RadioGroup
                value={formData.role}
                onValueChange={(value: 'doctor' | 'hospital') => 
